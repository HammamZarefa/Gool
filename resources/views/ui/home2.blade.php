    ...
    <div class="vehicles-area home-2">
        <div>
            <div class="section-title">
                <div class="loading-spinner bg-white justify-content-center align-items-center d-none">
                    ...
                    <div class="d-flex flex-wrap" style='display: flex;'>
                            ...
                            <div class="" id="sports-menu" style='background: #060606'>
                                ...
                                <div class="" id="{{$sport}}">
                                    <div  style='background: #060606' class=" pl-2 pr-2 align-items-center d-flex justify-content-between border-bottom clickable main-caory sublist-header">
                                        ...
                                        <span class="fw-bold text-white" id="teams-count-{{$sport}}">1267</span>
                                    </div>
                                @foreach($countries as $country)
                                    @if($country->sport == $sport)
                                        <div class="container-sm-fluid clickable subcategory mb-2" id="sub-category-{{$country->sport}}">
                                            <div class="p-1 side-sprt d-flex justify-content-between align-items-center country" data-name="{{$country->country}}" data-league="1" data-time="4" data-write="F">
                                                <div class="ps-1">
                                                    <img src="1" height="20px" width="20px">
                                                </div>
                        ...
                        <div class="ms-lg-2 col-lg-2 col-sm-12 mt-sm-2 mb-sm-3 mb-lg-0 mt-lg-0">
                            <div class="row shadow bg-light rounded-3 bets-table" style="display: flex;">
                                <div class="container-lg container-sm-fluid text-center pb-1 pt-3 header border-bottom bg-light">
                                    <h2>BET SLIP</h2>
                ...
                <script>
                    ...
                    function makeBet(element, selection_name, bet_value){
                        ...
                        const bet_item = $(`<div class="border-bottom bet p-1" id="bet-${event_id}" data-event-info='${event_json}'>
                                                    <div class="d-flex">
                                                    ...
                                                    <div class="fw-bold pt-2">MAC BAHISI</div>
                                                    ...
                                                    <div class="d-flex justify-content-center align-items-center p-2">
                                                        <button class="btn btn-danger d-flex align-items-center cancel-bet" data-event-id="${event_id}">
                            ...
                            $.each(result, function (index, ticket_result){
                                const ticket = $(`
                                    <div class="clickable row ticket d-flex mb-2" data-ticket-id="${ticket_result.invoice_id}">
                                        <div class="col">${ticket_result.invoice_id}</div>
                                    </div>
                                `);
