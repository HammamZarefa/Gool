                    ...
                    @foreach($testimonials as $data)
                        <div class="single-testimonial">
                            <div class="img-wrapper">
                                @if($data->image == null)
                                    <img src="{{ asset('images/user/default.jpg') }}" class="w-80" alt="{{$data->name}}">
                                @else
                                    <img src="{{ asset('images/testimonial/'.$data->image)}}" alt="{{$data->name}}">
                                @endif
                            </div>
                        ...
                        <div class="single-partner-item ">
                            <div class="outer-container">
                                <div class="inner-container">
                                    <img src="{{asset('images/gateways/'.$data->image)}}" alt="{{$data->name}}">
                                </div>
                            </div>
                        </div>
                    @endforeach
