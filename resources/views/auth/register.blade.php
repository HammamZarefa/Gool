...
@section('css')
    <link rel="stylesheet" href="{{asset('templates/css/intlTelInput.css')}}">
@stop
...
@section('js')
    <script src="{{asset('templates/js/intlTelInput.js')}}"></script>
    <script>
        ...
        $("#phone").intlTelInput({
            ...
            initialCountry: "auto",
            utilsScript: "{{asset('templates/js/utils.js')}}"
        });
    </script>
@endsection
