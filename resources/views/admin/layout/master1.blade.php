...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{asset('admin/css/bootstrap-fileinput.css')}}">
  ...
  <body>
    ...
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <a class="navbar-brand brand-logo" href="{{url('/')}}"><img src="{{asset('images/logo/footer-logo.png')}}" alt="logo" /></a>
          <a class="navbar-brand brand-logo-mini" href="{{url('/')}}"><img src="{{asset('images/logo/footer-logo.png')}}" alt="logo" /></a>
        </div>
    ...
    <script src="{{asset('admin/js/bootstrap-notify/bootstrap-notify.min.js')}}"></script>
