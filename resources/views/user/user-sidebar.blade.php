    ...
    <div class="card mt-2">
        <div class="card-body ">
            <div class="user-menu list-group">
                ...
                <a href="{{route('home')}}" class="@if(Request::routeIs('home')) active @endif list-group-item list-group-item-action ">Sports Bets<i class="mdi mdi-wallet float-right"></i></a>
