...
<head>
    ...
    <!-- slicknav css -->
    <link rel="stylesheet" href="{{asset('templates/css/slicknav.css')}}">
    <!-- main css -->
...
<!-- waypoints js -->
<script src="{{asset('templates/js/waypoints.min.js')}}"></script>
<!-- counterup js -->
<script src="{{asset('templates/js/jquery.counterup.min.js')}}"></script>
<!-- slicknav js -->
<script src="{{asset('templates/js/jquery.slicknav.min.js')}}"></script>
<!-- main js -->
