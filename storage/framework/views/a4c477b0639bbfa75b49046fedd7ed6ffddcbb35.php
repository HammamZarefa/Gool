            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-8">
                            <form class="forms-sample" role="form" action="<?php echo e(route('user.status',[$user->id])); ?>"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="zip_code" value="<?php echo e($user->zip_code); ?>"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <select name="phone_verify" id="phone_verify" class="form-control">
                                            <option value="1" <?php if($user->phone_verify  == 1): ?> selected <?php endif; ?>>Yes
                                            </option>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="email_verify" id="email_verify" class="form-control">
                                            <option value="1" <?php if($user->email_verify  == 1): ?> selected <?php endif; ?>>Yes
                                            </option>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="is_admin" id="is_admin" class="form-control">
                                            <option value="1" <?php if($user->is_admin  == 1): ?> selected <?php endif; ?>>Yes</option>
                                            <option value="0" <?php if($user->is_admin  == 0): ?> selected <?php endif; ?>>No</option>
                                        </select>
                                        <?php if($errors->has('status')): ?>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\projects\Gool\resources\views/admin/users/details.blade.php ENDPATH**/ ?>