...
<script>
    ...
    $('#tickets-container .bet-tick').on('click', function(){
        ...
        request(`invoiceshow?invoice_id=${id}`, function (result) {
            ...
            $(".bet-details").append($(
                ` <button onclick="myFunction10(${id})" id="btnnn" class="bet-btn" style="width: 90%;margin: auto;"><?php echo app('translator')->get('Print'); ?></button>`
            ));
                                    ...
                                    <div class="container mb-3">
                                        <div class="d-flex flex-column border border-2 border-dark p-2">
                                            <div class="d-flex w-100 justify-content-between">
                                                ...
                                                <span class="text-white fw-bolder"><?php echo e(auth()->user()->username); ?></span>
                                            </div>
                                            <div class="d-flex w-100 justify-content-between">
