                              ...
                              <?php $__currentLoopData = $logs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                      <tr>
                                          ...
                                          <td data-label="<?php echo app('translator')->get('Username'); ?>">
                                              <a href="<?php echo e(route('user.single',$data->transferForm->id)); ?>">
                                                  <?php echo e($data->transferForm->username); ?>

                                              </a>
                                          </td>
                                          <td data-label="<?php echo app('translator')->get('Amount'); ?>"><?php echo $data->amount; ?> <?php echo $basic->currency; ?></td>
                                          <td data-label="<?php echo app('translator')->get('Charge'); ?>"><?php echo $data->charge; ?> <?php echo $basic->currency; ?></td>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\gool10bet\resources\views/admin/users/transfer-receive.blade.php ENDPATH**/ ?>