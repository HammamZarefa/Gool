                ...
                <div class="card-body">
                    ...
                    <h4 class="card-title mb-5">
                       <div class="row justify-content-end">
                           <div class="col-4">
                               <a href="<?php echo e(route('user.create')); ?>" class="btn btn-lg btn-gradient-success" >Add New</a>
                           </div>
                           <div class="col-4"></div>
                           <div class="col-4">
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\projects\Gool\resources\views/admin/users/index.blade.php ENDPATH**/ ?>