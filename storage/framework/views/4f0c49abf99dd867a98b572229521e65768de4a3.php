                ...
                <div class="transaction_wrapper float_left smoke_bg ">
                        <div class="row p-3">
                            ...
                            <div class="row shadow bg-light rounded-3 bets-table" style="display: flex;">
                                ...
                                <div style="background-color: #a90404;">
                            ...
                            request(`live-matches`,
                                function(result){
                                    ...
                                    <div class="row live-match mb-1" style="background: linear-gradient(to bottom,#034379 1%,#012b4f 27%,#00223e 64%);">
                                        ...
                                        <div class="col-4 d-flex align-items-center" style="background: #e2e2e2;">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Gool\resources\views/ui/livesport.blade.php ENDPATH**/ ?>