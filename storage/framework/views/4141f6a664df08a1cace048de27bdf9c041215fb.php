    ...
    <div class="card mt-2">
        <div class="card-body ">
            <div class="user-menu list-group">
                ...
                <a href="<?php echo e(route('home')); ?>" class="<?php if(Request::routeIs('home') || Request::routeIs('invoice_bet')): ?> active <?php endif; ?> list-group-item list-group-item-action ">Sports Bets<i class="mdi mdi-wallet float-right"></i></a>
