            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                        <?php $__currentLoopData = $questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr <?php if($data->result == 1): ?> class="danger" <?php endif; ?>>
                                <td data-label="SL"><?php echo e(++$k); ?></td>
                                <td data-label="Question">
                                    <strong><?php echo e($data->question); ?></strong>
                                </td>
                                <td data-label="Event"><?php echo e($data->match->name); ?></td>
                                <td  data-label="End Time"><?php echo e((date('d M Y h:i A',strtotime($data->end_time)))); ?></td>

                                <td data-label="Predictors">

                                        <a href="<?php echo e(route('awaiting.winner.userlist',$data->id)); ?>"
                                ...
                                <td data-label="Action">
                                    ...
                                    <?php if($data->result == 1): ?>
                                        <a href="<?php echo e(route('view.option.endtime',$data->id)); ?>"
                                    ...
                                    <?php else: ?>
                                        ...
                                        <?php if(in_array('22',$access)): ?>
                                            <button type="button"
                                                    ...
                                                    data-act="Edit"
                                                    data-matchenddate="<?php echo e(date('d M, Y h:i:s A',strtotime($data->match->end_date))); ?>"
                                                    data-name="<?php echo e($data->question); ?>"
                                                    data-datetime="<?php echo e(date('h:i A',strtotime($data->end_time))); ?>"
                                                    data-enddate="<?php echo e(date('m/d/Y',strtotime($data->end_time))); ?>"
                                                    data-status="<?php echo e($data->status); ?>"
                                                    data-id="<?php echo e($data->id); ?>"
                                                    data-mid="<?php echo e($data->match_id); ?>">
    ...
    <div class="modal fade" id="EditMyModal" tabindex="-1" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="post" action="<?php echo e(route('update.question')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-7">
                                ...
                                <p class="text-danger"><?php echo e($errors->first('end_date')); ?></p>
                            </div>
                            <div class="col-md-5">
                                ...
                                <p class="text-danger"><?php echo e($errors->first('end_time')); ?></p>
                            </div>
                            <div class="col-md-12">
    ...
    <div class="modal fade" id="refundMyModal" tabindex="-1" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="post" action="<?php echo e(route('refundBetInvest')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="modal-body">
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\gool10bet\resources\views/admin/result/awaiting-list.blade.php ENDPATH**/ ?>