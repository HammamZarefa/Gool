              ...
              <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-primary card-img-holder text-white">
                  <div class="card-body">
                    ...
                    <h2 class="mb-5"> <?php echo e($pridictor['tournament']); ?></h2>
              ...
              <div class="col-md-3 stretch-card grid-margin">
                <div class="card bg-gradient-info card-img-holder text-white">
                  <div class="card-body">
                    ...
                    <h2 class="mb-5"><?php echo e($basic->currency_sym); ?> <?php echo e(number_format($pridictionInvest, $basic->decimal)); ?></h2>
              ...
              <div class="col-md-3 stretch-card grid-margin">
                <div class="card bg-gradient-danger card-img-holder text-white">
                  <div class="card-body">
                    ...
                    <h2 class="mb-5"> <?php echo e($basic->currency_sym); ?> <?php echo e(number_format($pridictionRefund, $basic->decimal)); ?></h2>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-3 stretch-card grid-margin">
                <div class="card bg-gradient-dark card-img-holder text-white">
                  <div class="card-body">
                    ...
                    <h2 class="mb-5"> <?php echo e($basic->currency_sym); ?> <?php echo e(number_format($pridictionReturn, $basic->decimal)); ?></h2>
                  </div>
                </div>
              </div>

              <div class="col-md-3 stretch-card grid-margin">
                <div class="card <?php if($totalProfit > 0): ?> bg-gradient-success <?php else: ?> bg-gradient-danger <?php endif; ?> card-img-holder text-white">
                  <div class="card-body">
                    <img src="<?php echo e(asset('images/dashboard/circle.svg')); ?>" class="card-img-absolute" alt="circle-image" />
                    <h4 class="font-weight-normal mb-3">Total Profit From Prediction<i class="mdi  mdi-currency-usd   mdi-24px float-right"></i>
                    </h4>
                    <h2 class="mb-5"> <?php echo e($basic->currency_sym); ?> <?php echo e($totalProfit); ?></h2>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-3 stretch-card grid-margin">
                <div class="card bg-gradient-dark card-img-holder text-white">
                  <div class="card-body">
                    ...
                    <h2 class="mb-5"><?php echo e($basic->currency_sym); ?> <?php echo e(number_format($betReturnCharge, $basic->decimal)); ?></h2>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-3 stretch-card grid-margin">
                <div class="card bg-gradient-success card-img-holder text-white">
                  <div class="card-body">
                    ...
                    <h2 class="mb-5"> <?php echo e($basic->currency_sym); ?> <?php echo e(number_format($depositCharge, $basic->decimal)); ?></h2>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-3 stretch-card grid-margin">
                <div class="card bg-gradient-primary card-img-holder text-white">
                  <div class="card-body">
                    ...
                    <h2 class="mb-5"> <?php echo e($basic->currency_sym); ?> <?php echo e(number_format($withdrawCharge, $basic->decimal)); ?></h2>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-3 stretch-card grid-margin">
                <div class="card bg-gradient-info card-img-holder text-white">
                  <div class="card-body">
                    ...
                    <h2 class="mb-5"> <?php echo e($basic->currency_sym); ?> <?php echo e(number_format($transferCharge, $basic->decimal)); ?></h2>
                  </div>
                </div>
              </div>
                      ...
                      <div class="col-md-6 stretch-card grid-margin">
                        <div class="card bg-gradient-primary card-img-holder text-white">
                          <div class="card-body">
                            ...
                            <h2 class="mb-5"> <?php echo e($deposit); ?></h2>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6 stretch-card grid-margin">
                        <div class="card bg-gradient-info card-img-holder text-white">
                          <div class="card-body">
                            ...
                            <h2 class="mb-5"> <?php echo e($depositLog); ?></h2>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6 stretch-card grid-margin">
                        <div class="card bg-gradient-success card-img-holder text-white">
                          <div class="card-body">
                            ...
                            <h2 class="mb-5"><?php echo e($withdrawMethod); ?> </h2>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6 stretch-card grid-margin">
                        <div class="card bg-gradient-danger card-img-holder text-white">
                          <div class="card-body">
                            ...
                            <h2 class="mb-5"> <?php echo e($withdrawLog); ?></h2>
                          </div>
                        </div>
                      </div>
              ...
              <div class="col-md-8 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <canvas id="pridiction" data-month="<?php echo json_encode($betInvest_counter['month'], 15, 512) ?>" class="mt-4"></canvas>
                  </div>
                </div>
              </div>
