                ...
                <div class="card-body">
                    ...
                    <table class="table">
                        ...
                        <?php $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr <?php if($invoice->result == 1): ?> class="danger" <?php endif; ?>>
                                <td data-label="user"><?php echo e($invoice->user->username); ?></td>
                                <td data-label="Event"><?php echo e($invoice->coupon_id); ?></td>
                                <td data-label="Event"><?php echo e($invoice->date); ?></td>
                                <td data-label="End Time"><?php echo e($invoice->amount); ?></td>
                                <td data-label="End Time"><?php echo e($invoice->possible_win); ?></td>
                                <td data-label="End Time"><?php echo e($invoice->status); ?></td>
                            </tr>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\projects\Gool\resources\views/admin/invoice/index.blade.php ENDPATH**/ ?>